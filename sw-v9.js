const CACHE_NAME="van-ginger-v9-nav-clean";
const APP_SHELL=["./","./index.html","./styles-v9.css","./app-v9.js","./manifest.json","./assets/icon-192.png","./assets/icon-512.png","./assets/van-fur-v7.webp","./assets/ginger-fur-v7.webp","./assets/van-ginger-splash-v7.webp"];
...
self.addEventListener("fetch",event=>{
  ...
  const isVersioned=/styles-v9\.css$|app-v9\.js$|sw-v9\.js$/.test(url.pathname);
